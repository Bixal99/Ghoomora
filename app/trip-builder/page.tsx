...
import { getPackages, getPickupCities, getRegions } from "@/lib/data";
...
export default async function TripBuilder({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  const pickup = typeof params.pickup === "string" ? params.pickup : "islamabad";
