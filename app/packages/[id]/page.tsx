  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="section-pad bg-[#e5eee9]"><div className="container-shell"><p className="eyebrow text-[#5a7f73]">OpenRouteService · regional roads</p><h2 className="display-title mt-2 text-5xl md:text-7xl">See how the journey moves.</h2><p className="mt-4 max-w-2xl leading-7 text-muted-foreground">Distance, driving time and elevation are planning estimates. Local jeep tracks and hikes remain separate from the main road line.</p><div className="mt-9"><RouteExperience packageId={pkg.id} /></div></div></section>
